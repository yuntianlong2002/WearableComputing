...
public class CSVAdapter extends ArrayAdapter<State>{
    ...
    public View getView(final int pos, View convertView, final ViewGroup parent){
        ...
        mView.setText(getItem(pos).getName()+" "+getItem(pos).getCapital());
    ...
    private void loadArrayFromFile(){
        ...
        mRawAccFile = new File(Environment.getExternalStorageDirectory(), "stress.csv");
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try{
                    Date date = dateFormat.parse(RowData[0]);
                ...
                long currentDateTime = Long.parseLong(RowData[0]);
                Date date = new Date(currentDateTime);
                DateFormat formatter = new SimpleDateFormat("HH:mm:ss");
                String dateFormatted = formatter.format(date);
                cur.setName(dateFormatted);
